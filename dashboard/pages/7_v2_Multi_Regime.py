...
cio_v2 = load_variant_current_cio("v2_score_aggressive_pcr")
macro_v2 = load_variant_current_macro("v2_score_aggressive_pcr")
...
if cio_v2 is None or macro_v2 is None:
    ...
    with st.expander("Board Memo (CIO 의사결정 메모)"):
        memo = load_variant_board_memo("v2_score_aggressive_pcr")
